...
abstract class AbstractMarkerHelper {
    ...
    private IMarker findMarker(IResource resource, String message, int lineNumber, String type) throws CoreException {
        ...
        for (int i = 0; i < marker.length; i++) {
            ...
            boolean sameMessageAndLineNr = SimpleStringUtils.equals(markerLineNumber, String.valueOf(lineNumber)) && SimpleStringUtils.equals(markerMessage, message);
    ...
    private void createMarker(IResource resource, String message, int lineNumber, String markerType, int severity, int charStart, int charEnd) throws CoreException {
        if (lineNumber <= 0)
            lineNumber = 1;
