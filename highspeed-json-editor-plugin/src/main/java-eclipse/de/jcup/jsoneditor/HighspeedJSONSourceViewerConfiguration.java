...
import static de.jcup.jsoneditor.preferences.HighspeedJSONEditorSyntaxColorPreferenceConstants.*;
...
import de.jcup.jsoneditor.document.HighspeedJSONDocumentIdentifier;
import de.jcup.jsoneditor.document.HighspeedJSONDocumentIdentifiers;
import de.jcup.jsoneditor.presentation.HighspeedJSONDefaultTextScanner;
import de.jcup.jsoneditor.presentation.PresentationSupport;
/**
 * 
...
public class HighspeedJSONSourceViewerConfiguration extends TextSourceViewerConfiguration {
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		addPresentation(reconciler, DOUBLE_STRING.getId(), getPreferences().getColor(COLOR_STRING),SWT.NONE);
